...
public class SolarPanelInstallation extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solar_panel_installation);

        dropdown1 = findViewById(R.id.drop_down1);
        ArrayAdapter<String> myAdapter1 = new ArrayAdapter<String>(SolarPanelInstallation.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.schedule));
        ...
        service_name = findViewById(R.id.solar_installation_name);
        wage_or_salary = findViewById(R.id.solar_installation_wage);
        education = findViewById(R.id.solar_installation_edu);
        experience = findViewById(R.id.solar_installation_experience);
        company_name = findViewById(R.id.solar_installation_company_name);
        short_description = findViewById(R.id.solar_installation_descr);
        address = findViewById(R.id.solar_installation_address);
        phone_num = findViewById(R.id.solar_installation_phone_num);
        InputProductImage = findViewById(R.id.solar_installation_image);
        Add_a_New_Product = findViewById(R.id.publish_solar_installation);
        image = findViewById(R.id.solar_installation_image1);
    ...
    private void ValidateProductData() {
        ...
        } else if (TextUtils.isEmpty(company_name1)) {
            Toast.makeText(this, "Company Name?", Toast.LENGTH_SHORT).show();
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(SolarPanelInstallation.this, "Error. " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(SolarPanelInstallation.this, "Product Image uploaded successfully", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SolarPanelInstallation.this, "Product Image has been saved Successfully!", Toast.LENGTH_SHORT).show();
        ...
        ProductsRef.child(ProductUID + ProductRandomKey).updateChildren(ProductMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Intent intent = new Intent(SolarPanelInstallation.this, ShopActivity.class);
                            intent.putExtra("uid", ProductUID);
                            startActivity(intent);

                            loadingBar.dismiss();

                            Toast.makeText(SolarPanelInstallation.this, "Product is added successfully", Toast.LENGTH_SHORT).show();
