...
public class SolarInverterDetails extends AppCompatActivity {


    private TextView power, spec_features;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solar_inverter_details);
        ...
        product_description = (TextView) findViewById(R.id.solar_inverter_product_details_description);
        product_price = (TextView) findViewById(R.id.solar_inverter_product_details_price);
        product_address = (TextView) findViewById(R.id.solar_inverter_product_details_address);
        product_phone_num = (TextView) findViewById(R.id.solar_inverter_call_me_baby);
        power = (TextView) findViewById(R.id.solar_inverter_product_details_type);
        spec_features = (TextView) findViewById(R.id.solar_inverter_product_details_power);
        product_message = findViewById(R.id.solar_inverter_product_message);
        circleImageView = findViewById(R.id.solar_inverter_watch_seller_image);
        delete_txt = findViewById(R.id.delete_txt_solar_inverter);
        edit_txt = findViewById(R.id.edit_txt_solar_inverter);

        Seller_Nick = findViewById(R.id.solar_inverter_seller_nick);

        product_details_cart = findViewById(R.id.solar_inverter_product_details_cart);


        product_phone_num.setVisibility(View.VISIBLE);


        recyclerView = findViewById(R.id.rec_solar_inverter);
                        ...
                        databaseReference.child(productID).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    power.setText(products.getPower());
                                    ...
                                    circleImageView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            if (CurrentUserID.equals(DatabaseUserID)) {
                                                ...
                                                Intent intent = new Intent(SolarInverterDetails.this, MyProfileActivity.class);
                                                startActivity(intent);

                                            } else {

                                                Intent intent = new Intent(SolarInverterDetails.this, UserData.class);
                                    ...
                                    product_message.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            Intent intent = new Intent(SolarInverterDetails.this, ChatActivity.class);
                                            intent.putExtra("visit_user", DatabaseUserID);
                                    ...
                                    product_phone_num.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (ActivityCompat.checkSelfPermission(SolarInverterDetails.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                                                return;
                                            }
                                            startActivity(intent);
                                        }
                                    ...
                                    if (CurrentUserID.equals(DatabaseUserID)) {
                                        ...
                                        product_message.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            @Override
                                            public void onClick(View v) {
                                                Intent intent = new Intent(SolarInverterDetails.this, EditSolarInverter.class);
                                                intent.putExtra("p_uid", productID);
                                                startActivity(intent);
                                            }
                                        });
                                        ...
                                        product_details_cart.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(SolarInverterDetails.this);
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        if (which == 0) {
                                                            ...
                                                            Intent intent = new Intent(SolarInverterDetails.this, ShopActivity.class);
                                                            startActivity(intent);
                                                            Toast.makeText(SolarInverterDetails.this, "Ad has been deleted successfully.", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        cartListRef.child("User View").child(CurrentUserID).child("Products").child(productID)
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                Toast.makeText(SolarInverterDetails.this, "Product was added successfully", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                    }
                                                });
