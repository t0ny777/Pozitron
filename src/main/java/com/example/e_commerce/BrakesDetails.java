...
public class BrakesDetails extends AppCompatActivity {


    private TextView spec_features;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brakes_details);
        ...
        product_description = (TextView) findViewById(R.id.brakes_product_details_description);
        product_price = (TextView) findViewById(R.id.brakes_product_details_price);
        product_address = (TextView) findViewById(R.id.brakes_product_details_address);
        product_phone_num = (TextView) findViewById(R.id.brakes_call_me_baby);
        spec_features = (TextView) findViewById(R.id.brakes_product_details_power);
        product_message = findViewById(R.id.brakes_product_message);
        circleImageView = findViewById(R.id.brakes_watch_seller_image);
        edit_txt = findViewById(R.id.edit_txt_brakes);
        delete_txt = findViewById(R.id.delete_txt_brakes);
        Seller_Nick = findViewById(R.id.brakes_seller_nick);
        product_details_cart = findViewById(R.id.brakes_product_details_cart);

        recyclerView = findViewById(R.id.rec_brakes);
                    ...
                    protected void onBindViewHolder(@NonNull final product_view_holder holder, int position, @NonNull final Products model) {
                        ...
                        databaseReference.child(productID).addValueEventListener(new ValueEventListener() {
                                                                                             ...
                                                                                             circleImageView.setOnClickListener(new View.OnClickListener() {
                                                                                                 ...
                                                                                                 public void onClick(View view) {
                                                                                                     if (CurrentUserID.equals(DatabaseUserID)) {
                                                                                                         ...
                                                                                                         Intent intent = new Intent(BrakesDetails.this, MyProfileActivity.class);
                                                                                                         startActivity(intent);

                                                                                                     } else {

                                                                                                         Intent intent = new Intent(BrakesDetails.this, UserData.class);
                                    ...
                                    product_message.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            Intent intent = new Intent(BrakesDetails.this, ChatActivity.class);
                                            intent.putExtra("visit_user", DatabaseUserID);
                                    ...
                                    product_phone_num.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (ActivityCompat.checkSelfPermission(BrakesDetails.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                                                return;
                                            }
                                            startActivity(intent);
                                        }
                                    ...
                                    if (CurrentUserID.equals(DatabaseUserID)) {
                                        ...
                                        product_message.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            @Override
                                            public void onClick(View v) {
                                                Intent intent = new Intent(BrakesDetails.this, EditBrakes.class);
                                                intent.putExtra("p_uid", productID);
                                                startActivity(intent);
                                            }
                                        });
                                        ...
                                        product_details_cart.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(BrakesDetails.this);
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        if (which == 0) {
                                                            ...
                                                            Intent intent = new Intent(BrakesDetails.this, ShopActivity.class);
                                                            startActivity(intent);
                                                            Toast.makeText(BrakesDetails.this, "Ad has been deleted successfully.", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        cartListRef.child("User View").child(CurrentUserID).child("Products").child(productID)
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                Toast.makeText(BrakesDetails.this, "Product was added successfully", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                    }
                                                });
