...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private TextView product_phone_num, capacity, compatibility, delete_txt, edit_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product_description = (TextView) findViewById(R.id.battery_product_details_description);
        product_price = (TextView) findViewById(R.id.battery_product_details_price);
        product_address = (TextView) findViewById(R.id.battery_product_details_address);
        product_phone_num = (TextView) findViewById(R.id.battery_call_me_baby);
        capacity = (TextView) findViewById(R.id.battery_product_details_type);
        compatibility = (TextView) findViewById(R.id.battery_product_details_power);
        product_message = findViewById(R.id.battery_product_message);
        circleImageView = findViewById(R.id.battery_watch_seller_image);
        delete_txt = findViewById(R.id.delete_txt_battery);
        edit_txt = findViewById(R.id.edit_txt_battery);



        Seller_Nick = findViewById(R.id.battery_seller_nick);

        product_details_cart = findViewById(R.id.battery_product_details_cart);


        product_phone_num.setVisibility(View.VISIBLE);


        recyclerView = findViewById(R.id.rec_battery);
                        ...
                        databaseReference.child(productID).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    capacity.setText(products.getCapacity());
                                    ...
                                    circleImageView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            if (CurrentUserID.equals(DatabaseUserID)) {
                                                ...
                                                Intent intent = new Intent(ProductDetailsActivity.this, MyProfileActivity.class);
                                                startActivity(intent);

                                            } else {

                                                Intent intent = new Intent(ProductDetailsActivity.this, UserData.class);
                                    ...
                                    if (CurrentUserID.equals(DatabaseUserID)) {
                                        ...
                                        product_message.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            @Override
                                            public void onClick(View v) {
                                                Intent intent = new Intent(ProductDetailsActivity.this, EditAdActivity.class);
                                                intent.putExtra("p_uid", productID);
                                                startActivity(intent);
                                            }
                                        });
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        if (which == 0) {
                                                            ...
                                                            startActivity(intent);
                                                            Toast.makeText(ProductDetailsActivity.this, "Ad has been deleted successfully.", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        cartListRef.child("User View").child(CurrentUserID).child("Products").child(productID)
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                Toast.makeText(ProductDetailsActivity.this, "Product was added successfully", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                    }
                                                });
