...
public class SolarPanelDetails extends AppCompatActivity {


    private TextView type, power;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solar_panel_details);
        ...
        product_description = (TextView) findViewById(R.id.solar_panel_product_details_description);
        product_price = (TextView) findViewById(R.id.solar_panel_product_details_price);
        product_address = (TextView) findViewById(R.id.solar_panel_product_details_address);
        product_phone_num = (TextView) findViewById(R.id.solar_panel_call_me_baby);
        type = (TextView) findViewById(R.id.solar_panel_product_details_type);
        power = (TextView) findViewById(R.id.solar_panel_product_details_power);
        product_message = findViewById(R.id.solar_panel_product_message);
        circleImageView = findViewById(R.id.solar_panel_watch_seller_image);
        delete_txt = findViewById(R.id.delete_txt_solar_panel);
        edit_txt = findViewById(R.id.edit_txt_solar_panel);

        Seller_Nick = findViewById(R.id.solar_panel_seller_nick);

        product_details_cart = findViewById(R.id.solar_panel_product_details_cart);


        product_phone_num.setVisibility(View.VISIBLE);


        recyclerView = findViewById(R.id.rec_solar_panel);
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    circleImageView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            if (CurrentUserID.equals(DatabaseUserID)) {
                                                ...
                                                Intent intent = new Intent(SolarPanelDetails.this, MyProfileActivity.class);
                                                startActivity(intent);

                                            } else {

                                                Intent intent = new Intent(SolarPanelDetails.this, UserData.class);
                                    ...
                                    product_message.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            Intent intent = new Intent(SolarPanelDetails.this, ChatActivity.class);
                                            intent.putExtra("visit_user", DatabaseUserID);
                                    ...
                                    product_phone_num.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (ActivityCompat.checkSelfPermission(SolarPanelDetails.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                                                return;
                                            }
                                            startActivity(intent);
                                        }
                                    ...
                                    if (CurrentUserID.equals(DatabaseUserID)) {
                                        ...
                                        product_message.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            @Override
                                            public void onClick(View v) {
                                                Intent intent = new Intent(SolarPanelDetails.this, EditSolarPanel.class);
                                                intent.putExtra("p_uid", productID);
                                                startActivity(intent);
                                            }
                                        });
                                        ...
                                        product_details_cart.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(SolarPanelDetails.this);
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        if (which == 0) {
                                                            ...
                                                            Intent intent = new Intent(SolarPanelDetails.this, ShopActivity.class);
                                                            startActivity(intent);
                                                            Toast.makeText(SolarPanelDetails.this, "Ad has been deleted successfully.", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        cartListRef.child("User View").child(CurrentUserID).child("Products").child(productID)
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                Toast.makeText(SolarPanelDetails.this, "Product was added successfully", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                    }
                                                });
