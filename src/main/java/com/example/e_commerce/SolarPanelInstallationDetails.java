...
public class SolarPanelInstallationDetails extends AppCompatActivity {


    private TextView job, wage_salary, schedule, education, experience, company_name;
    ...
    private TextView delete_txt, edit_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solar_panel_installation_details);
        ...
        product_description = (TextView) findViewById(R.id.solar_job_product_details_description);
        job = findViewById(R.id.solar_job_product_details_type);
        wage_salary = findViewById(R.id.solar_job_product_details_wage);
        product_address = (TextView) findViewById(R.id.solar_job_product_details_address);
        product_phone_num = (TextView) findViewById(R.id.solar_job_product_details_phone_number);
        product_message = findViewById(R.id.solar_job_product_message);
        circleImageView = findViewById(R.id.solar_job_watch_seller_image);
        schedule = findViewById(R.id.solar_job_product_details_schedule);
        education = findViewById(R.id.solar_job_product_details_education);
        company_name = findViewById(R.id.solar_job_product_details_company_name);
        experience = findViewById(R.id.solar_job_product_details_experience);
        delete_txt = findViewById(R.id.delete_txt_solar_job);
        edit_txt = findViewById(R.id.edit_txt_solar_job);

        Seller_Nick = findViewById(R.id.solar_job_seller_nick);

        product_details_cart = findViewById(R.id.solar_job_product_details_cart);


        product_phone_num.setVisibility(View.VISIBLE);


        recyclerView = findViewById(R.id.rec_solar_job);
                        ...
                        databaseReference.child(productID).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    wage_salary.setText(products.getWage_salary());
                                    delete_txt.setText("Add to Cart");
                                    edit_txt.setText("Type a Message");
                                    job.setText(products.getJob());
                                    schedule.setText(products.getSchedule());
                                    education.setText(products.getEducation());
                                    experience.setText(products.getExperience());
                                    company_name.setText(products.getCompany_name());
                                    ...
                                    circleImageView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            if (CurrentUserID.equals(DatabaseUserID)) {
                                                ...
                                                Intent intent = new Intent(SolarPanelInstallationDetails.this, MyProfileActivity.class);
                                                startActivity(intent);

                                            } else {

                                                Intent intent = new Intent(SolarPanelInstallationDetails.this, UserData.class);
                                    ...
                                    product_message.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            Intent intent = new Intent(SolarPanelInstallationDetails.this, ChatActivity.class);
                                            intent.putExtra("visit_user", DatabaseUserID);
                                    ...
                                    product_phone_num.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (ActivityCompat.checkSelfPermission(SolarPanelInstallationDetails.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                                                return;
                                            }
                                            startActivity(intent);
                                        }
                                    ...
                                    if (CurrentUserID.equals(DatabaseUserID)) {
                                        ...
                                        product_message.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            @Override
                                            public void onClick(View v) {
                                                Intent intent = new Intent(SolarPanelInstallationDetails.this, EditSolarPanelInstallation.class);
                                                intent.putExtra("p_uid", productID);
                                                startActivity(intent);
                                            }
                                        });
                                        ...
                                        product_details_cart.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(SolarPanelInstallationDetails.this);
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        if (which == 0) {
                                                            ...
                                                            Intent intent = new Intent(SolarPanelInstallationDetails.this, ShopActivity.class);
                                                            startActivity(intent);
                                                            Toast.makeText(SolarPanelInstallationDetails.this, "Ad has been deleted successfully.", Toast.LENGTH_SHORT).show();
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                holder.txt_cart.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        cartListRef.child("User View").child(CurrentUserID).child("Services").child(productID)
                                                                .updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                Toast.makeText(SolarPanelInstallationDetails.this, "Product was added successfully", Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                    }
                                                });
